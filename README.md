...
```bash
git clone https://github.com/sickboy81/Astryxion.git
cd Astryxion
cp .env.example .env
...
```bash
curl -s "https://astryxion.com/api/v1/horoscope/aries" \
...
```bash
curl -s -X POST "https://astryxion.com/api/v1/natal-chart" \
  -H "Authorization: Bearer dev_test_key" \
...
```bash
curl -s -X POST "https://astryxion.com/api/v1/chart/natal-svg" \
  -H "Authorization: Bearer dev_test_key" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "https://astryxion.com/api/v1/natal/llm-context" \
  -H "Authorization: Bearer dev_test_key" \
  -H "Content-Type: application/json" \
...
echo file_get_contents("https://astryxion.com/api/v1/natal-chart", false, $ctx);
```
...
req, _ := http.NewRequest("POST", "https://astryxion.com/api/v1/natal-chart", body)
...
npx @openapitools/openapi-generator-cli generate \
  -i https://astryxion.com/api/v1/openapi.json \
  -g typescript-axios \
  -o ./sdk
```
